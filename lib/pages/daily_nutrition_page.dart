...
class _DailyNutritionPageState extends State<DailyNutritionPage> {
  late final DailyNutritionController nutritionController;

  @override
  void initState() {
    super.initState();
    nutritionController = Get.find<DailyNutritionController>();
  }
    ...
    return Scaffold(
        ...
        bottom: PreferredSize(
          ...
          child: Align(
            ...
            child: Obx(() => Padding(
                  ...
                  child: Text(
                    'Nutrisi Harian - ${nutritionController.dateFormatted.value}',
      ...
      body: Obx(() {
        ...
        return RefreshIndicator(
          onRefresh: () async {
            await nutritionController.loadSavedData();
          },
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if (nutritionController.targetCalories.value > 0)
            ...
            Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      'Usia ${nutritionController.ageController.text} bulan',
                      style: const TextStyle(
                        fontSize: 16,
                        fontFamily: 'Signika',
                        fontWeight: FontWeight.w600,
                    ...
                    Text(
                      'Berat ${nutritionController.weightController.text} kg (${_getWeightStatusText(nutritionController.weightStatus.value)})',
                      style: TextStyle(
                        fontSize: 14,
                        fontFamily: 'Signika',
                        color: _getWeightStatusColor(
                            nutritionController.weightStatus.value),
                      ),
                    ),
                  ],
                ),
            ...
            Row(
              ...
              children: [
                _buildNutrientSummaryBox(
                  'Kalori',
                  '${nutritionController.targetCalories.value.toStringAsFixed(0)} kcal',
                  Icons.local_fire_department,
                  AppStyles.warningColor,
                ),
                _buildNutrientSummaryBox(
                  'Protein',
                  '${nutritionController.targetProtein.value.toStringAsFixed(1)} g',
                  Icons.fitness_center,
                  AppStyles.errorColor,
                ),
                _buildNutrientSummaryBox(
                  'Karbo',
                  '${nutritionController.targetCarbs.value.toStringAsFixed(1)} g',
                  Icons.grain,
                  AppStyles.successColor,
                ),
                _buildNutrientSummaryBox(
                  'Lemak',
                  '${nutritionController.targetFat.value.toStringAsFixed(1)} g',
                  Icons.opacity,
                  AppStyles.infoColor,
                ),
              ],
  ...
  Widget _buildNutritionSummaryCard() {
    ...
    int ageInMonths = 0;
    try {
      ageInMonths = int.parse(nutritionController.ageController.text);
    } catch (e) {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              TextButton.icon(
                onPressed: () => nutritionController.resetDaily(),
                icon: const Icon(
                  Icons.refresh,
          ...
          nutritionController.targetCalories.value == 0
              ? _buildEmptyState(
                  Icons.info_outline,
          ...
          getTooltipItem: (group, groupIndex, rod, rodIndex) {
            ...
            switch (group.x) {
              case 0:
                nutrientName = 'Kalori';
                value =
                    '${nutritionController.consumedCalories.value.toStringAsFixed(0)}/${nutritionController.targetCalories.value.toStringAsFixed(0)} kcal';
                color = AppStyles.warningColor;
                break;
              case 1:
                nutrientName = 'Protein';
                value =
                    '${nutritionController.consumedProtein.value.toStringAsFixed(1)}/${nutritionController.targetProtein.value.toStringAsFixed(1)} g';
                color = AppStyles.errorColor;
                break;
              case 2:
                nutrientName = 'Karbo';
                value =
                    '${nutritionController.consumedCarbs.value.toStringAsFixed(1)}/${nutritionController.targetCarbs.value.toStringAsFixed(1)} g';
                color = AppStyles.successColor;
                break;
              default:
                nutrientName = 'Lemak';
                value =
                    '${nutritionController.consumedFat.value.toStringAsFixed(1)}/${nutritionController.targetFat.value.toStringAsFixed(1)} g';
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: TextField(
                  controller: nutritionController.ageController,
                  decoration: InputDecoration(
                    ...
                    errorText: nutritionController.ageError.value.isEmpty
                        ? null
                        : nutritionController.ageError.value,
                  ),
              ...
              Expanded(
                child: TextField(
                  controller: nutritionController.weightController,
                  decoration: InputDecoration(
                    labelText: 'Berat (kg)',
                    labelStyle: const TextStyle(
                      color: AppStyles.primaryColor,
                    ...
                    contentPadding: const EdgeInsets.symmetric(
                        horizontal: 12, vertical: 12),
                    errorText: nutritionController.weightError.value.isEmpty
                        ? null
                        : nutritionController.weightError.value,
                  ),
                  keyboardType:
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              onPressed: () {
                ...
                try {
                  final ageNum =
                      int.parse(nutritionController.ageController.text);
                  if (ageNum <= 0 || ageNum > 24) {
                    nutritionController.ageError.value =
                        'Usia harus antara 1-24 bulan';
                    isValid = false;
                  } else {
                    nutritionController.ageError.value = '';
                  }
                } catch (e) {
                  nutritionController.ageError.value = 'Usia tidak valid';
                  isValid = false;
                }
                ...
                try {
                  final weightNum =
                      double.parse(nutritionController.weightController.text);
                ...
                Future.delayed(const Duration(seconds: 1), () {
                  Get.back();
                  nutritionController.calculateRequirements(
                    nutritionController.ageController.text,
                    nutritionController.weightController.text,
                  );
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Obx(() => nutritionController.consumedFoods.isEmpty
            ? _buildEmptyState(
                Icons.no_food,
...
Widget _buildFoodLogList() {
  ...
  return ListView.separated(
    ...
    itemCount: nutritionController.consumedFoods.length,
    separatorBuilder: (context, index) => const SizedBox(height: 8),
    itemBuilder: (context, index) {
      final food = nutritionController.consumedFoods[index];
      return Dismissible(
        ...
        onDismissed: (_) => nutritionController.removeFood(index),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (nutritionController.targetIron.value > 0) ...[
              const SizedBox(height: 16),
              _buildNutrientProgressBar(
                'Zat Besi',
                '${nutritionController.consumedIron.value.toStringAsFixed(1)}/${nutritionController.targetIron.value.toStringAsFixed(1)} mg',
                percentages['iron']!,
                Colors.brown,
                Icons.bloodtype,
              ),
            ...
            Row(
              ...
              children: [
                TextButton.icon(
                  onPressed: () {
                    Get.back();
                    nutritionController.resetDaily();
                  },
                  icon: const Icon(
                    Icons.refresh,
                    color: AppStyles.errorColor,
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: OutlinedButton.icon(
                  onPressed: () {
                    Get.back();
                    _showCustomFoodInputDialog(isUnder6Months: isUnder6Months);
                  },
                  icon: const Icon(
                    Icons.add_circle_outline,
                    color: AppStyles.primaryColor,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final bool isRecommended = !isUnder6Months ||
                          (food.name.toLowerCase().contains('asi') ||
                              food.name.toLowerCase().contains('susu formula'));
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: const Text(
                      'Lanjutkan',
                      style:
                          TextStyle(fontFamily: 'Signika', color: Colors.white),
                    ),
                  ),
                ),
              ],
...
Widget _buildPortionButton(String title, String subtitle, VoidCallback onTap) {
  return InkWell(
    onTap: onTap,
    child: Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            CalendarDatePicker(
              initialDate: nutritionController.currentDate.value,
              firstDate: DateTime.now().subtract(const Duration(days: 30)),
              lastDate: DateTime.now(),
              onDateChanged: (date) {
                nutritionController.currentDate.value = date;
                nutritionController.dateFormatted.value =
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            nutritionController.consumedFoods.isEmpty
                ? _buildEmptyState(
                    Icons.no_food,
...
// Add this method to your _DailyNutritionPageState class
Widget _buildEmptyState(IconData icon, String title, String subtitle) {
  return Padding(
    padding: const EdgeInsets.symmetric(vertical: 24),
    child: Center(
